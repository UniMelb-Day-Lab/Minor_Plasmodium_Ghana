...
* **antimal_treat**: Antimalarial treatment in the previous 2 weeks as reported by the participant (i.e., Yes, No, Don't know (DK))
* **ParaGrp_PCR**: *Plasmodium* spp. status based on PCR (e.g., Pf PCR + = _P. falciparum_ positive, PCR - = _Plasmodium_ negative, Pf PCR +/Pm PCR + = _P. falciparum/P. malariae_ positive, etc.)
